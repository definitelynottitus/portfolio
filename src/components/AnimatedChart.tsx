...
const firstBar = {
    hidden: {
        opacity:0,
        d: "M238.747,791.149V1079.808c0-2.71,3.949-4.908,8.82-4.908h39.36c4.871,0,8.82,2.2,8.82,4.908V791.7Z"
    },
    visible: {
        opacity:1,
...
const secondBar = {
    hidden: {
        opacity:0,
        d: "M368.748,790.71V1100.9a8.82,8.82,0,0,1,8.82-8.82h39.36a8.82,8.82,0,0,1,8.82,8.82h0V791.25Z"
    },
    visible: {
        opacity:1,
        d: "M368.748,790.71V410.9a8.82,8.82,0,0,1,8.82-8.82h39.36a8.82,8.82,0,0,1,8.82,8.82h0V791.25Z"
    }
}
...
const thirdBar = {
    hidden: {
        opacity:0,
        d: "M498.748,791.9v10a8.82,8.82,0,0,1,8.82-8.82h39.36a8.82,8.82,0,0,1,8.82,8.82h0V791.25Z"
    },
    visible: {
        opacity:1,
...
const fourthBar = {
    hidden: {
        opacity:0,
        d: "M628.747,790.405V693.635c0-6.371,3.949-11.536,8.82-11.536h39.36c4.871,0,8.82,5.165,8.82,11.536V791.7Z"
    },
    visible: {
        opacity:1,
...
const fiveBar = {
    hidden: {
        opacity:0,
        d:"M758.748,790.554V952.8c0-5.614,3.949-10.166,8.82-10.166h39.36c4.871,0,8.82,4.551,8.82,10.166V791.7Z"
    },
    visible: {
        opacity:1,
...
const chartLine = {
    ...
    visible: {
        ...
        opacity:1 , 
        transition: {
            pathLength: { delay:1, type: "spring", duration: 1, bounce: 0 },
            opacity: { delay:1, type: "spring", duration: 0.5, bounce: 0 },
        }
    },
}

const chartBottomLine = {
    hidden: { 
        pathLength: 0,
        opacity:0,
    },
...
const circle = {
    ...
    visible: (i:number) => {
      return {
        opacity: 1,
        transition: {
            opacity: { delay:i, type: "spring", duration: 0.5, bounce: 0 },
        }
      };
    }
};
...
export const AnimatedChart = () => {
    return (
        ...
        >
            <polygon points="755.994 674.556 743.734 674.555 737.902 627.268 755.996 627.268 755.994 674.556" fill="#fee2e2"/>
            <path d="M948.53667,792.539l-39.53076-.00146v-.5a15.3873,15.3873,0,0,1,15.38647-15.38623h.001l24.144.001Z" transform="translate(-189.41599 -106.099)" fill="#2f2e41"/>
            <polygon points="708.994 674.556 696.734 674.555 690.902 627.268 708.996 627.268 708.994 674.556" fill="#fee2e2"/>
            <path d="M901.53667,792.539l-39.53076-.00146v-.5a15.3873,15.3873,0,0,1,15.38647-15.38623h.001l24.144.001Z" transform="translate(-189.41599 -106.099)" fill="#2f2e41"/>
            <Path 
                variants={firstBar}
            ...
            <Path 
                variants={fourthBar}
                transition={{ duration: 1, type: "spring" ,stiffness: 70, delay:0.6}}
                transform="translate(-189.41599 -106.099)" 
                fill="#e5e5e5"/>
            <Path 
                variants = {fiveBar}
            ...
            />
            <Circle custom={0.4} cy="324" cx="77.832" r="28" fill="#e5e5e5"/>
            <Circle custom={0.8}  cx="207.832" cy="179" r="28" fill="#ccc"/>
            <Circle custom={1}  cx="337.832" cy="252" r="28" fill="#e6e6e6"/>
            <Circle custom={1.2} cx="467.832" cy="28" r="28" fill="#e5e5e5"/>
            <circle cx="717.832" cy="236.535" r="28" fill="#e5e5e5"/>
            <path d="M897.348,560.755c10.47981,1.26236,37.279-8.29806,38.73146,6.24641,13.7938,40.605,13.38448,196.25632,13.38448,196.25632l-21,1S911.683,640.58334,903.74813,614.12488c-3.98187,32.159-3.28421,155.13285-3.28421,155.13285l-19,1s-17.04317-104.7174-17.14045-135.45308c-2.07126-22.51351,3.00876-55.87593.83463-77.63979a83.21836,83.21836,0,0,0,32.19,3.59Z" transform="translate(-189.41599 -106.099)" fill="#2f2e41"/>
            <path d="M861.698,442.955a130.65716,130.65716,0,0,0-15.31-24.17,38.322,38.322,0,0,1-3.4-4.64c-2.15-3.73-2.79-8.11-4.15-12.19-3.8-11.44-13.28-20.63-15.59-32.46-.84-4.3-7.93567,8.19791-6.07,13.53,3.33,9.65,3.76,19.87,8,29.19s9.22,18.26,12.88,27.79c2.08,5.41,3.74,11,6.79,16s7.81,9.19,13.56,9.94a33.44983,33.44983,0,0,1,1.63013-10.68C861.288,451.325,863.508,446.685,861.698,442.955Z" transform="translate(-189.41599 -106.099)" fill="#fee2e2"/>
            <path d="M924.608,449.435a55.25867,55.25867,0,0,1,3.25-20.78c.92-2.55,2-5.14,1.91-7.85-.13-2.52-1.33-4.83-2.42-7.11-3.76-7.85-6.4-16.17-9-24.47l-5-15.65c-1.63018-1.19543,7.89-1.61,9.92,1.2,6.64,9.22,11.67,19.81,16.93005,29.88a50.57714,50.57714,0,0,1,3.42,7.49,41.18565,41.18565,0,0,1,1.8,12.94c0,8.19-1.07995,16.35-2.19995,24.47-.71,5.09-1.64,10.63-5.49,14C933.72793,458.435,929.708,453.435,924.608,449.435Z" transform="translate(-189.41599 -106.099)" fill="#fee2e2"/>
            <circle cx="708.75198" cy="314.48401" r="20.75" fill="#fee2e2"/>
            <path d="M881.29986,399.881a3.602,3.602,0,0,1,.75956-3.72335c.51814-.40831,1.20624-.56062,1.7617-.95027a7.602,7.602,0,0,0,1.89952-2.40314,10.31516,10.31516,0,0,1,12.909-3.27672c3.42909,1.79484,5.49957,5.38869,8.54935,7.80841,1.54823,1.25389,3.34408,2.18449,4.90161,3.43838a20.14613,20.14613,0,0,1,6.35451,10.27787,58.31035,58.31035,0,0,1,1.7617,12.12454,10.90476,10.90476,0,0,1-.142,3.68607,10.31659,10.31659,0,0,1-1.39586,2.84979c-3.13478,4.7493-7.26645,9.0623-12.4437,11.5131s-11.47477,2.84979-16.58055.285a2.84975,2.84975,0,0,1-1.27259-1.01658,3.65791,3.65791,0,0,1-.199-2.19382,15.01763,15.01763,0,0,0-1.65284-8.40634c-.95027-1.89951-2.37516-3.53373-3.13479-5.49956a19.15971,19.15971,0,0,1-.89328-6.81979C882.39205,411.59309,882.79831,405.63756,881.29986,399.881Z" transform="translate(-189.41599 -106.099)" fill="#2d293d"/>
            <Path
                variants = {chartBottomLine} 
